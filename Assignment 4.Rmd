...
# Q2
### Create a matrix including only integer variables from the data.  Call this matrix XC. Change every integer variable in XC to 
### numeric variable and scale them (see scale()). Do not do it manually. You must use a loop or lapply/sapplyfunctions (15 Points).
